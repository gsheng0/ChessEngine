...
public class Constants {
    ...
    // Pawns
    // Knights
    public static final int[] KNIGHT_SHIFTS = new int[] { 17, 15, 10, 6, -6, -10, -15, -17 };
    public static final long[] KNIGHT_PRUNES = new long[] {
    ...
    // Bishops
    public static final int[] BISHOP_SHIFTS = new int[] { 7, -7, 9, -9 };
    public static final long[] BISHOP_PRUNES = new long[] {
            ~EIGHTH_RANK & ~H_FILE,
            ~FIRST_RANK & ~A_FILE,
            ~EIGHTH_RANK & ~A_FILE,
            ~FIRST_RANK & ~H_FILE,
    ...
    public static final long[] ROOK_PRUNES = new long[] {
            ~EIGHTH_RANK,
            ~FIRST_RANK,
            ~A_FILE,
            ~H_FILE,
    ...
    // Queens
    public static final int[] QUEEN_SHIFTS = new int[] { 8, -8, 1, -1, 7, -7, 9, -9 };
    public static final long[] QUEEN_PRUNES = new long[] {
            ~EIGHTH_RANK,
            ~FIRST_RANK,
            ~A_FILE,
            ~H_FILE,
    ...
    // Kings
    public static final int[] KING_SHIFTS = new int[] { 8, -8, 1, -1, 7, -7, 9, -9 };
    public static final long[] KING_PRUNES = new long[] {
            ~EIGHTH_RANK,
            ~FIRST_RANK,
            ~A_FILE,
            ~H_FILE,
    ...
    public static final int[][] SHIFTS = new int[][] {
            new int[1],
            KNIGHT_SHIFTS,
            BISHOP_SHIFTS,
            ROOK_SHIFTS,
    ...
    public static final long[][] PRUNES = new long[][] {
            new long[1],
            KNIGHT_PRUNES,
            BISHOP_PRUNES,
            ROOK_PRUNES,
